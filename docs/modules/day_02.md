...
If a word starts with a consonant letter, but the first sound is an open vowel, it requires **An**. This happens all the time with silent 'H's and IT acronyms where the name of the letter starts with an "E" or "A" sound.
