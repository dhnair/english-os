---
title: "Day 17: The Pre-Flight Check (4-Hour Full System Revision)"
sidebar_position: 17
---

# Day 17: The Pre-Flight Check (4-Hour Full System Revision)
...
:::info Study Strategy (Live Code Review)
...
**1. The Variable Pointers (A/An vs. The):**
Test your ability to initialize new variables versus pointing to cached data.
...
**4. Code Splitting & Checksums:** * Take the separable phrasal verb *"Pick up."* Insert the pronoun *"it."* *(Pick it up).*
* Add a Checksum to this statement: *"We haven't finished the revision, \_\_\_\_\_?"* *(have we?)*
